...
nrated_usr = np.array(data.get_cols_nratings(learn, "userBijId"), dtype=np.uint32)
...
nratings_mvi = np.array(data.get_cols_nratings(learn, "movieBijId"), dtype=np.uint32)
